...
**Lưu ý quan trọng:** File này mô tả phép trừ số có dấu sử dụng phương pháp **SIGNED MAGNITUDE** (bit dấu + phần trị). Để thực hiện phép trừ số có dấu bằng phương pháp **TWO'S COMPLEMENT** (bù 2 - chuẩn máy tính), xem file 4.2.8.
