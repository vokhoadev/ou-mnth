...
Bước 2: Chuyển 14₈ sang nhị phân để kiểm tra
14₈ = 1×8¹ + 4×8⁰ = 8 + 4 = 12₁₀ = 1100₂ (4 bit)

Bước 3: Kiểm tra phạm vi
4 bit: 0 ≤ 12 ≤ 15 ✓

Kết quả: 12₁₀ = 14₈ (4 bit không dấu)
Lưu ý: Biểu diễn 4 bit nhị phân tương ứng là 1100₂
```
...
Bước 2: Chuyển F₁₆ sang nhị phân để kiểm tra
F₁₆ = 1111₂ (4 bit)

Bước 3: Kiểm tra phạm vi
4 bit: 0 ≤ 15 ≤ 15 ✓

Kết quả: 15₁₀ = F₁₆ (4 bit không dấu)
Lưu ý: Biểu diễn 4 bit nhị phân tương ứng là 1111₂
```
...
Bước 2: Chuyển 144₈ sang nhị phân để kiểm tra
144₈ = 1×8² + 4×8¹ + 4×8⁰ = 64 + 32 + 4 = 100₁₀ = 01100100₂ (8 bit)

Bước 3: Kiểm tra phạm vi
8 bit: 0 ≤ 100 ≤ 255 ✓

Kết quả: 100₁₀ = 144₈ (8 bit không dấu)
Lưu ý: Biểu diễn 8 bit nhị phân tương ứng là 01100100₂
```
...
Bước 2: Chuyển FF₁₆ sang nhị phân để kiểm tra
FF₁₆ = 11111111₂ (8 bit)

Bước 3: Kiểm tra phạm vi
8 bit: 0 ≤ 255 ≤ 255 ✓

Kết quả: 255₁₀ = FF₁₆ (8 bit không dấu)
Lưu ý: Biểu diễn 8 bit nhị phân tương ứng là 11111111₂
```
...
Bước 2: Chuyển 11610₈ sang nhị phân để kiểm tra
11610₈ = 1×8⁴ + 1×8³ + 6×8² + 1×8¹ + 0×8⁰ = 4096 + 512 + 384 + 8 + 0 = 5000₁₀
5000₁₀ = 0001001110001000₂ (16 bit)

Bước 3: Kiểm tra phạm vi
16 bit: 0 ≤ 5000 ≤ 65535 ✓

Kết quả: 5000₁₀ = 11610₈ (16 bit không dấu)
Lưu ý: Biểu diễn 16 bit nhị phân tương ứng là 0001001110001000₂
```
...
65535₁₀ ÷ 16 = 4095 dư 15 (F)
4095₁₀ ÷ 16 = 255 dư 15 (F)
255₁₀ ÷ 16 = 15 dư 15 (F)
15₁₀ ÷ 16 = 0 dư 15 (F)
→ 65535₁₀ = FFFF₁₆

Bước 2: Chuyển FFFF₁₆ sang nhị phân để kiểm tra
FFFF₁₆ = 1111111111111111₂ (16 bit)

Bước 3: Kiểm tra phạm vi
16 bit: 0 ≤ 65535 ≤ 65535 ✓

Kết quả: 65535₁₀ = FFFF₁₆ (16 bit không dấu)
Lưu ý: Biểu diễn 16 bit nhị phân tương ứng là 1111111111111111₂
```
