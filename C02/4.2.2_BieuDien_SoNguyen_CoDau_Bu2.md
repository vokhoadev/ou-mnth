...
Bước 2: Lấy giá trị tuyệt đối và chuyển sang nhị phân 4 bit
5₁₀ = 0101₂

Bước 3: Đảo tất cả các bit (bù 1)
0101₂ → 1010₂

Bước 4: Cộng 1 để có bù 2
1010₂ + 1 = 1011₂
...
Kiểm tra: 1011₂ là bù 2 của 0101₂ (5₁₀) ✓
```
...
Kiểm tra: 1001₂ là bù 2 của 0111₂ (7₁₀) ✓
```
...
Bước 2: Lấy giá trị tuyệt đối và chuyển sang nhị phân 8 bit
25₁₀ = 00011001₂
...
Kiểm tra: 11100111₂ là bù 2 của 00011001₂ (25₁₀) ✓
```
...
Kiểm tra: 10000001₂ là bù 2 của 01111111₂ (127₁₀) ✓
```
...
Bước 2: Lấy giá trị tuyệt đối và chuyển sang nhị phân 16 bit
1000₁₀ = 0000001111101000₂

Bước 3: Đảo tất cả các bit (bù 1)
0000001111101000₂ → 1111110000010111₂

Bước 4: Cộng 1 để có bù 2
1111110000010111₂ + 1 = 1111110000011000₂

Bước 5: Kiểm tra phạm vi
16 bit: -32768 ≤ -1000 ≤ 32767 ✓

Kết quả: -1000₁₀ = 1111110000011000₂ (16 bit bù 2)
Kiểm tra: 1111110000011000₂ là bù 2 của 0000001111101000₂ (1000₁₀) ✓
```
