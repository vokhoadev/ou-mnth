...
**Lưu ý quan trọng:** File này mô tả phép chia số có dấu sử dụng phương pháp **SIGNED MAGNITUDE** (bit dấu + phần trị). Để thực hiện phép chia số có dấu bằng phương pháp **TWO'S COMPLEMENT** (bù 2 - chuẩn máy tính), xem các file trong phần 4.2.
...
### Bài 4: Chia -6 ÷ 2 trong 4 bit có dấu
