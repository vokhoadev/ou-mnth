...
**Lưu ý quan trọng:** File này mô tả chuyển đổi số có dấu sử dụng phương pháp **SIGNED MAGNITUDE** (bit dấu + phần trị). Để chuyển đổi số có dấu bằng phương pháp **TWO'S COMPLEMENT** (bù 2 - chuẩn máy tính), xem các file trong phần 4.2.
...
## Bảng chuyển đổi (Signed Magnitude 4 bit):
...
**Lưu ý:** Trong Signed Magnitude, có hai biểu diễn cho số 0: +0 (0000₂) và -0 (1000₂). Phạm vi 4 bit là -7 đến 7, không có -8.
...
Bước 2: Chuyển 25₁₀ sang nhị phân
25₁₀ = 11001₂ (5 bit)
Phần trị 7 bit: 0011001₂ (thêm 2 bit 0 vào đầu)
...
Kết quả: -25₁₀ = 10011001₂ (8 bit có dấu, Signed Magnitude)
```
...
Kết quả: -1000₁₀ = 1000001111101000₂ (16 bit có dấu, Signed Magnitude)
```
...
### VÍ DỤ ỨNG DỤNG:
```cpp
// Chuyển đổi số nguyên có dấu (Signed Magnitude)
